    ...
    >
      ...
      <div className="flex-1 max-w-[1400px] mx-auto px-6 lg:px-12 py-24 pb-32">
        ...
        <div className="flex justify-between items-end mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-4xl font-normal tracking-tight text-white">
            Operating model
          </h2>
        </div>

        {/* Main Card */}
        <div className="border border-white/10 rounded-2xl bg-white/[0.01] flex flex-col md:flex-row shadow-[0_4px_40px_rgba(0,0,0,0.5)]">
          {/* Card Left Sidebar */}
          <div className="hidden md:flex flex-col items-center justify-center w-24 lg:w-32 border-r border-white/10 relative py-20 shrink-0">
            {/* Orange glowing line */}
            ...
            <span
              className="text-3xl lg:text-4xl font-bold tracking-[0.3em] text-white"
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="p-8 lg:p-12 pb-10">
              <p className="text-[10px] tracking-[0.2em] uppercase text-white/40 mb-6 font-medium">
                OPERATING MODEL
              </p>
              <h3 className="text-3xl sm:text-4xl lg:text-5xl font-semibold tracking-tight text-white mb-6">
                Measure. Own. Secure.
              </h3>
              <p className="text-[15px] sm:text-base text-white/80 leading-relaxed max-w-2xl mb-4">
                An operating model for Infra, Data, and AI built for speed with accountability.
              </p>
              <p className="text-[13px] sm:text-sm text-white/50 leading-relaxed max-w-2xl">
            ...
            <div className="flex flex-col">
              {modelSteps.map((item, idx) => (
                <div
                  key={idx}
                  className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 px-8 lg:px-12 py-10 border-t border-white/10"
                >
                  {/* Left Column */}
        ...
        <div className="mt-8 px-2 flex justify-start">
          <p className="text-[11px] sm:text-xs text-white/40 font-mono italic">
